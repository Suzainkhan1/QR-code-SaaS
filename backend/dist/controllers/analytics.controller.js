...
const getAnalytics = async (req, res) => {
    ...
    try {
        ...
        const todayBills = await db_1.prisma.bill.findMany({
            where: {
                restaurantId,
                isPaid: true,
        ...
        const allPaidBills = await db_1.prisma.bill.findMany({
        ...
        const allExpenses = await db_1.prisma.expense.findMany({
            where: { restaurantId },
